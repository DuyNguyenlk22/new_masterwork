    ...
    <div>
      <div className='footer__content py-12 bg-[#F7F9FC]'>
        <div className='container'>
                  ...
                  <div className='form-sign'>
                    <div className='flex mt-8 mb-5'>
                      <input
                        ...
                        className='w-[85%] px-5 py-3 rounded bg-[#F7F9FC] mr-4 color-title border-none'
                      />
          ...
          <div className='footer__bottom flex justify-between items-center mt-8 py-10 border-t-2 border-t-[#eee]'>
            <div className='right'>
