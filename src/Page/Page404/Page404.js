...
export default function Page404() {
  return (
    <div className='mt-[80px] lg:mt-[90px] px-4 py-10'>
      <div className='404__content max-w-[600px] m-auto flex flex-col items-center space-y-8'>
        ...
        <h1 className='text-[30px] font-bold color-title'>Oops, Page not found!</h1>
        ...
        <NavLink to={"/"}>
          <div className='space-x-3 color-title hover:text-[#dc4f72] duration-300'>
