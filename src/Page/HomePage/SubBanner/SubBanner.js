    ...
    <section className='subBanner'>
      <div className='container'>
        <div className='subBanner__Content max-w-[550px] text-white'>
          <div>
            <h2 className='text-[26px] leading-[36px] md:text-[30px] font-bold'>
              We are true to ourselves, and commit to always perform at our best.
            </h2>
            <p className='mt-6 mb-12'>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Necessitatibus, doloribus atque. Corrupti
