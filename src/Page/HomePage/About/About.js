      ...
      <div className='container py-4 md:px-6'>
        <div className='grid grid-cols-1 md:grid-cols-2 gap-16 mt-4 mb-20'>
          <div className='about__left'>
            ...
            <p className='mb-12'>
              Lorem ipsum dolor, sit amet consectetur adipisicing elit. Et est repellendus illum harum quam nihil totam
              reprehenderit! Ut sed eveniet quos! Asperiores officia, repudiandae similique reiciendis, ab est magnam
              esse nesciunt ea fuga facere voluptatem.
            </p>
        ...
        <div className='numberCounter grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
          {dataNumber.map((item, index) => {
            return (
              <div
                className={`${index === 2 ? "translate-x-0 md:translate-x-1/2 lg:translate-x-0" : ""} number__item`}
                key={`item${index}`}>
